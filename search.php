...
$res=mysqli_query($con,"select * from pgdetails  where accomdation like '%".$_GET['txt']."%' or pglocation like '%".$_GET['txt']."%'or description like '%".$_GET['txt']."%' or pgname like '%".$_GET['txt']."%'"); ?>
